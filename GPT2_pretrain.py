...
def main(args):
    ...
    for epoch in range(num_epochs):
        ...
        elif len(dev_losses) > 2 and dev_losses[-1] > dev_losses[-2] and dev_losses[-2] > dev_losses[-3]:
            logging.info("early stopping")
            break
        elif dev_losses[-1] < min(dev_losses[:-1]):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default='./saved_model_pretrainedGPT2_unsort_wiki103')
